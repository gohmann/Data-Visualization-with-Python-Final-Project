...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), Input(component_id='Yearly Statistics', component_property='value')])


def update_output_container(selected_report):
    if selected_report == 'Recession Period Statistics':
       # Create graphs for recession periods
        graph1 = dcc.Graph(figure=R_chart1)  # Replace with your figure
        graph2 = dcc.Graph(figure=R_chart2)
        graph3 = dcc.Graph(figure=R_chart3)
        graph4 = dcc.Graph(figure=R_chart4)
        ...
        # Handle other cases, e.g., Yearly Statistics
        return []
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Yearly Automobile Sales for Entire Period')) 
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata, x= 'Year', y= 'Automobile_Sales', title='Average Vehicles Sold by in the year {}'.format(input_year)))
        # Plot 4 Total Advertisement Expenditure for each vehicle using pie chart
         # grouping data for plotting.
         # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        exp_data=data.groupby('Vehicle_Type')['Advertising_Expenditure']
